<footer class="relative bg-gradient-to-br from-purple-900 to-purple-800 text-gray-200 pt-12 pb-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 text-center md:text-right">
            ...
            <div>
                ...
                <ul class="space-y-2">
                    ...
                    <li><a href="{{ asset('login') }}" class="hover:text-yellow-400 transition duration-300">تسجيل دخول الإدارة</a></li>
                </ul>
            </div>
    ...
    <div class="absolute inset-x-0 bottom-0 h-12 bg-gradient-to-t from-yellow-500/10 to-transparent blur-xl opacity-40">
    </div>
</footer>
